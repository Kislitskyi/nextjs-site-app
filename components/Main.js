    ...
    const handleChangeTextOfPlan = (type) => {
        ...
        switch (type) {
            case "zviazok":
                ...
                setTextOfPlan("Ви зв'язуєтеся з нами залишаючи заявку або по телефону, після цього ми починаемо обговорення проекту");
                break;
            case "ckl_dogovor":
                setTitleOfPlan("Складання плану та обговорення");
                setTextOfPlan("Вислуховуючи ваші побажання та при наявності наші рекомендації, ми підведемо підсумок нашої розмови, після чого, ми зможемо приступити до роботи");
                break;
            case "pidp_zviazok":
                setTitleOfPlan("Підписання договору");
                setTextOfPlan("Після складання технічного завдання ми укладаємо офіційний договір, що має юридичну силу");
                break;
            case "demka":
                setTitleOfPlan("Демонстрація сайту та його обговорення");
                setTextOfPlan("Ми вам продемонсрюємо зроблений сайт, якщо вам щось не сподобається, ви можете внести корегування, які ми одразу зробимо");
                break;
            case "zdaza_robotu":
                setTitleOfPlan("Здача роботи");
                setTextOfPlan("Ми здаємо вам усі файли у вихідних форматах");
                break;
        }
    }
        ...
        <ContainerMain>
            <ContentMain>
                <ContainerHeader id="home">
                    <ContainerNavBar className='findJsMenu scrolled'>
                        ...
                        <RightSideNavBar>
                            ...
                            <NavList className="navList" >
                                ...
                                <NavListLi>
                                    <p className='phonenumberlinon phonenumberforjs'>Phone placeholder</p>
                                </NavListLi>
                            </NavList>
                            {
                                isOpen == true ? (
                    ...
                    <ContentHeader>
                        ...
                        <LeftSideOfContentHeader>
                            <h1 id="typedText">
                                Робимо сайти під ваші потреби
                            </h1>
                            <h2>
                                Розрорбка сайту, назви, слогану, логотипу.<br></br><br></br>
                                Індивідуальний підхід до розпобки сайту згідно потреб замовника або на вибір шаблонів.
                                Зробимо все, щоб ві були задоволені.
                            </h2>
                ...
                <AboutUs id="about">
                    ...
                    <LeftSideOfAboutUs>
                        <TitleOfAboutUs>
                            <h2>Ми - молода, перспективна команда <span>ПРОГРАМІСТІВ</span></h2>
                        </TitleOfAboutUs>
                        <p>
                            Молода, сучасна команда, яка з задовенням задовільнить всі ваші потреби.
                            <br /><br />Підписуємо договір, у якому гарантуємо результат та несемо відповідальність.
                            В IT-сфері ми більше 5 років. Нашою метою є надання високоякісних послуг у веб-дизайні та веб-розробці. Запевнюємо вас, що ми будемо намагатися задовольнити всі ваші потреби.
                            <br /><br />Ми можемо зробити все, що забажаєте, починаючи з веб-дизайну до веб-додатків і інтернет-магазинів.
                        </p>
                        ...
                        <div className="blocks">
                            <ContainerBlock>
                                ...
                                <h3><Apartment className="icon" /> - 5</h3>
                                <span>Років у сфері</span>
                            </ContainerBlock>
                            <ContainerBlock>

                                <h3><Computer className="icon" /> - 30</h3>
                                <span>Вдалих наших проектів</span>
                            </ContainerBlock>
                            <ContainerBlock>

                                <h3><Group className="icon" /> - 108</h3>
                ...
                <Items id="services">
                    ...
                    <div className='ItemsDesc'>
                        <h2>Послуги</h2>
                        <p>Ми надаємо повний спектор послуг з розробки сайту під ключ, ми створюємо: логотип, назву, стиль та дизайн сайту, створюємо сам сайт</p>
                        <a onClick={handleShowPrices} href="#services2">Натисни щоб побачити більше нашого асортименту</a>
                    </div>
                    <div className='ItemsWhoJustStayingNotOpened'>
                        <div>
                ...
                
                    {
                        showPrices && (
                            <>
                                ...
                                <a onClick={handleShowPrices} href="#services"><Close className='crossClose' /></a>
                                <ServiceBody>
...
const LeftSideOfAboutUs = styled.div`
    ...
    .blocks {
        ...
        text-align: left;
        margin-top: 20px;
        /* animation: sliderInCss 15s ease infinite; */
    ...
    > button {
        background: linear-gradient(125deg, #0095d2, #0095d2,#5f00c1,#5f00c1); 
...
const SectionOfPlan = styled.div`
    ...
    > div {
        display: flex;
        background: linear-gradient(125deg, #fff,#fff,#0095d2, #5f00c1);
        align-items: center;
        background-size: 400% 400%;
        background-position: 0% 50%;
        overflow-wrap: break-word;
...
const Items = styled.div`
    ...
    > .ItemsWhoJustStayingNotOpened{
        ...
        >div{
            ...
            :hover .firstimg{
                transform: rotate(-15deg) translateX(-150px) translateY(-60px);
            ...
            :hover .thirdimg{
                box-shadow: 0px 0px 6px #000;
                transform: rotate(15deg) translateX(170px) translateY(-20px);
            }
